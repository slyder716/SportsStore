        ...
        public static void EnsurePopulated(IServiceProvider services)
        {
            ...
            if (!context.Products.Any())
            {
                context.Products.AddRange(
                    ...
                    new Product { Name = "Corner Flags", Description = "Give your playing field a professional touch.", Category = "Soccer", Price = 39.95m },
                    ...
                    new Product { Name = "Unsteady Chair", Description = "Secretly give your apponent a disadvantage", Category = "Chess", Price = 29.95m },
